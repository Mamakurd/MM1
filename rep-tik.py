...
''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
            print('\033[1;92m[+] Bzhe 7ab-xor report rooy')
        else:
            print('\033[0;92m[+] bzhe 7ab-xor report royy')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            print('\033[1;92m[+] bzhe 7ab-xor report royy')
        else:
            print('\033[0;31m[+] bzhe 7ab-xor report royy')
        time.sleep(3)
